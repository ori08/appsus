    ...
    render() {
        ...
        return <article className="email-container flex" >
            ...
            <div className="mail-link-icons">
                <img className="mail-icon first" onClick={() => this.mark(mail.id, 'selected')} src={iconsImg.selected} />
                <img className="mail-icon" onClick={() => this.mark(mail.id, 'starrad')} src={iconsImg.starrad} />
                <img className="mail-icon last" onClick={() => this.mark(mail.id, 'important')} src="assets/pics/asset 28.png" />
            </div>
